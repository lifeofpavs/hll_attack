...
ActiveRecord::Schema.define(version: 2020_08_10_215723) do
  ...
  create_table "executions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "time"
  ...
  create_table "tmp_presto_246010f22f1f446ca8e6d187d930037a", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.binary "hll", limit: 16777215
    t.date "date"
  end

  create_table "tmp_presto_55dafb19356b47aebb93dea87294faf0", id: false, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.binary "hll", limit: 16777215
    t.date "date"
  end
